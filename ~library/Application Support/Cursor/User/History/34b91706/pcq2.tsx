            ...
            <div ref={ref}>
                <FormSection tag="h1" title="nekocord Settings">
                    ...
                    <FormSection
                        title={
                            needsReload
                                ? "Please reload to apply the update!"
                                : updateAvailable
                                  ? "A nekocord update is available!"
                                  : "nekocord Updater"
                        }>
                        <Card
                            className={[
                            ...
                            <Flex direction={Flex.Direction.HORIZONTAL}>
                                ...
                                <Button
                                    color={Button.Colors.PRIMARY}
                                    className="nk-button-bar-button">
                                    View Changelog
                                </Button>
                            </Flex>
                        </Card>
                    ...
                    <FormSection title="Settings">
                        <FormSwitch
                            note={
                                "Allows you to install unverified third-party plugins. Doing so may harm your privacy and expose you to malicious content!"
                            }
                            hideBorder={true}
