...
function Bundle$Terminal(Data, Scr) {
    ...
    if (data[Data]) {
        ...
        if (Scr == "Terminal") {
            ...
            BEMA.Element("TextArea", "OpenBundle.Terminal." + instanceIDd + ".Display", 100, 75, windowWidth, windowHeight - 75, false, 10, 0, "", TermBase, TermText, "Welcome to Celeste Terminal\n", "left", 14, "Courier New", true, "", "");
    ...
    function processCommand(command) {
        ...
        if (cmd === "help") {
            ...
            output = SFS.gettime("HH:mm:ss") + " " + SFS.getdate("mm:dd:yyyy");
        } else if (cmd === "whoami") {
