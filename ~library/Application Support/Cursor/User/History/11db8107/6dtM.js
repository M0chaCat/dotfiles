...
webpackPatcher.onInitializationFinish(() => {
  this.channelStore = webpackModules.findByStoreName("channelStore");
});
webpackPatcher.onInitializationFinish(() => {
  this.GuildStore = webpackModules.findByStoreName("GuildStore");
});
