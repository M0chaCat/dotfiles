...
// Function to find and store the channel store
nekocord.webpackPatcher.onInitializationFinish(() => {
  stores.channelStore = nekocord.webpackModules.findByStoreName("channelStore");
});

// Function to find and store the Guild store
nekocord.webpackPatcher.onInitializationFinish(() => {
  stores.GuildStore = nekocord.webpackModules.findByStoreName("GuildStore");
});
