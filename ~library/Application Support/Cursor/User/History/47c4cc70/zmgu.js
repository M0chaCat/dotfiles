...
export function onEvent(id, event, callback) {
...
export function BEMA(type, id, x, y, width, height, autohide, rounded, borderWidth, borderColor, bgColor, textColor, text, textAlign, fontSize, fontFamily, readOnly, icon, iconColor) {
...
export function setupEventListeners(id) {
    const element = document.getElementById(id);
    if (element) {
...
export function timedLoop(interval, callback) {
...
export function shiftString(inputText, key) {
    var encodedString = "";
...
export function unshiftString(encodedString, key) {
    var decodedString = "";
...
export function checkSha256(message, expectedHash) {
