...
BEMA("TextArea", "DisplayText", -4.5, -4.5, 820, 580, true, 0, 0, Base, Base, Text, "Welcome to Dusk Emulated Terminal\n", "left", 15, "Tahoma", true, "", Text);
...
function setScreen(Screen) {
    hideAllScreens();
    if (Screen == "Home") {
        showElement("DisplayText");
        showElement("commandInput");
    }
}

function hideAllScreens() {
    hideElement("DisplayText");
...
registerUserCommands(addCommand);
