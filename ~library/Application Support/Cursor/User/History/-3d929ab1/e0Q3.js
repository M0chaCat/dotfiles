...
// Function to display the command and its output
...
function appendToDisplay(text) {
    var display = "Zarn"; // Assuming "Zarn" is the ID of the display area
    ...
    setText(display, getText(display) + "> "); // Add prompt for the next command
}
