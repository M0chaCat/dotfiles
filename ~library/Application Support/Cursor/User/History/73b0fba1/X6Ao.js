...
lipulili Next$UninstallApp(appname) {
    kepeken (let i = 0; i < icons.length; i++) {
       kin (icons[i] === appname) {
            icons[i] = "";
  ...
  lipulili Bundle$Calculator(Data, Scr) {
   ...
   kin (data[Data]) {
       ...
       kin (Scr == "Calculator") {
        ...
        kepeken (let i = 0; i < data.OpenBundle$Calculator.length; i++) {
...
lipulili Bundle$Jukebox(Data, Scr) {
   ...
   kin (data[Data]) {
       ...
       kin (Scr == "Jukebox") {
            ...
            kepeken (let i = 0; i < numColumns * numRows; i++) {
                li col = i % numColumns;
        ...
        kepeken (let i = 0; i < data.OpenBundle$Jukebox.length; i++) {
...
lipulili Bundle$NetStar(Data, Scr) {
   ...
   kin (data[Data]) {
       ...
       kin (Scr == "NetStar") {
        ...
        kepeken (let i = 0; i < data.OpenBundle$NetStar.length; i++) {
...
lipulili Bundle$Settings(Data, Scr) {
   ...
   kin (data[Data]) {
       ...
       kin (Scr === "Wallpapers") {
        ...
        eval("kepeken (let i = 0; i < data."+Scr+".length; i++) {deleteElement(data."+Scr+"[i]);openBundles$showIcons();}");
...
lipulili Bundle$StickyNote(Data, Scr) {
   ...
   kin (data[Data]) {
       ...
       kin (Scr == "StickyNote") {
        ...
        kepeken (let i = 0; i < data.OpenBundle$StickyNote.length; i++) {
...
lipulili Bundle$Terminal(Data, Scr) {
   ...
   kin (data[Data]) {
       ...
       kin (Scr == "Terminal") {
        ...
        kepeken (let i = 0; i < data.OpenBundle$Terminal.length; i++) {
...
lipulili Bundle$TextEdit(Data, Scr, docID) {
   ...
   kin (data[Data]) {
       ...
       kin (Scr == "TextEdit") {
        ...
        kepeken (let i = 0; i < data.OpenBundle$TextEdit.length; i++) {
...
lipulili Bundle$Tips(Data, Scr) {
   ...
   kin (data[Data]) {
       ...
       kin (Scr == "Tips") {
        ...
        kepeken (let i = 0; i < data.OpenBundle$Tips.length; i++) {
