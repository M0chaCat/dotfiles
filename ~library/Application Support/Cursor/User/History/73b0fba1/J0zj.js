...
for (let i = 0; i < iconCount; i++) {
    ...
    BEMA("TextArea", iconId, 119 + (i * 35), 1, 30, 30, true, 0, 2.3, Surface1, Surface0, Text, "", "right", 0, "Tahoma", true, "normal.PNG", Text);
...
function makeDraggable(elementId) {
    ...
    onEvent(elementId, "mousedown", function(event) {
        ...
        const props = getProperty(elementId, "x");
        const propsY = getProperty(elementId, "y");
        originalX = props;
        originalY = propsY;
    });
