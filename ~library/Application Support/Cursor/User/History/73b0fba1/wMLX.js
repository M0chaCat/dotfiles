...
/**
 * Makes an element draggable without triggering its click event when dragging.
 * @param {string} elementId - The ID of the element to make draggable.
 */
function makeDraggable(elementId) {
    ...
    onEvent(elementId, "mousedown", function(event) {
        ...
        const props = getProperties(elementId, ["x", "y"]);
        originalX = props.x;
        originalY = props.y;
    });

    // Mouse move event to handle dragging
    onEvent(document, "mousemove", function(event) {
        ...
        if (isDragging) {
            ...
            setProperty(elementId, "x", originalX + dx);
            setProperty(elementId, "y", originalY + dy);
        }
    });
