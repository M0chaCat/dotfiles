...
for (let i = 0; i < iconCount; i++) {
    ...
    // Make Icon 1 draggable
    if (i === 0) { // Icon 1 has index 0
        makeDraggable(iconId);
    }
    
    // Existing click handlers
    onEvent(iconId, "click", (e) => {
...
// Ensure makeDraggable function is correctly implemented
function makeDraggable(elementId) {
    console.log(`makeDraggable called for elementId: ${elementId}`);
    ...
    setProperty(elementId, "position", "absolute");
    ...
    onEvent(elementId, "mousedown", function(event) {
        console.log(`mousedown on ${elementId} at (${event.clientX}, ${event.clientY})`);
        isDragging = false;
        preventClick = false;
        ...
        const currentX = getProperty(elementId, "x");
        const currentY = getProperty(elementId, "y");
        originalX = parseFloat(currentX) || 0;
        originalY = parseFloat(currentY) || 0;
    });
    ...
    document.addEventListener("mousemove", function(event) {
        ...
        if (!isDragging) {
            if (Math.sqrt(dx * dx + dy * dy) > dragThreshold) {
                ...
                console.log(`isDragging started on ${elementId}`);
            }
        }
        ...
        if (isDragging) {
            ...
            setProperty(elementId, "x", newX);
            setProperty(elementId, "y", newY);
    ...
    document.addEventListener("mouseup", function(event) {
        if (isDragging) {
            console.log(`mouseup on ${elementId}, stopping drag`);
            isDragging = false;
            dragStartX = null;
            dragStartY = null;
        }
    ...
    // Modify the existing click event to respect drag state
    // Store the original click handler
    const originalClickHandler = handleClick.bind(null, elementId);

    // Override the click event
    onEvent(elementId, "click", function(e) {
        if (!preventClick) {
            console.log(`click on ${elementId}`);
            originalClickHandler(e);
        }
        // Reset preventClick flag
        preventClick = false;
    });
}

/**
 * Handles the original click event for an element.
 * @param {string} elementId - The ID of the element that was clicked.
 * @param {object} event - The event object.
 */
function handleClick(elementId, event) {
    // Retrieve the existing click handler
    // Assuming you have stored the click handlers somewhere, else manage accordingly
    // For this example, we'll manually trigger the existing click logic

    // Example for Next.Main.Bar.1
    if (elementId === "Next.Main.Bar.1") {
        const appName = icons[0];
        openBundles$openApp(appName);
        console.log(appName);
        console.log(icons);
        console.log(Apps);
    ...
    // Add similar conditions if you have multiple elements with click handlers
}
  ...
  function Bundle$Calculator(Data, Scr) {
    ...
    if (data[Data]) {
        ...
        if (Scr == "Calculator") {
            ...
            BEMA("TextArea", "OpenBundle.Calculator." + instanceIDd + ".WindowHeader", 100+100, 35+101, windowWidth, 25, false, 0, 0, "", Surface0, Text, "Calculator", "center", 12, "Tahoma", true, "", "");
...
function Bundle$Jukebox(Data, Scr) {
    ...
    if (data[Data]) {
        ...
        if (Scr == "Jukebox") {
            ...
            BEMA("TextArea", "OpenBundle.Jukebox." + instanceIDd + ".WindowHeader", 100+100, 35+101, 410, 25, false, 0, 0, "", Surface0, Text, "Jukebox", "center", 12, "Tahoma", true, "", "");
...
function Bundle$NetStar(Data, Scr) {
    ...
    if (data[Data]) {
        ...
        if (Scr == "NetStar") {
            ...
            BEMA("TextArea", "OpenBundle.NetStar." + instanceIDd + ".WindowHeader", 100+100, 35+101, 390, 25, false, 0, 0, "", Surface0, Text, "NetStar", "center", 12, "Tahoma", true, "", "");
...
function Bundle$Settings(Data, Scr) {
    ...
    if (data[Data]) {
        ...
        if (Scr === "Settings") {
            ...
            BEMA("TextArea", "OpenBundle.Settings." + instanceIDd + ".WindowHeader", windowX+100, headerY+101, 300, 25, false, 0, 0, "", Surface0, Text, "Settings", "center", 12, "Tahoma", true, "", "");
        ...
        if (Scr === "About") {
            ...
            BEMA("TextArea", "OpenBundle.SettingsAbout." + instanceIDd + ".WindowHeader", windowX+100, headerY+101, 300, 25, false, 0, 0, "", Surface0, Text, "Settings - About", "center", 12, "Tahoma", true, "", "");
        ...
        if (Scr === "Wallpapers") {
            ...
            BEMA("TextArea", "OpenBundle.Wallpaper." + instanceIDd + ".WindowHeader", windowX+100, headerY+101, windowWidth, 25, false, 0, 0, "", Surface0, Text, "Wallpapers", "center", 12, "Tahoma", true, "", "");
...
function Bundle$StickyNote(Data, Scr) {
    ...
    if (data[Data]) {
        ...
        if (Scr == "StickyNote") {
            ...
            BEMA("TextArea", "OpenBundle.StickyNote." + instanceIDd + ".WindowHeader", 100+100, 100+100, 200, 15, false, 0, 0, "", "#e8d19e", Base, "", "center", 5, "Tahoma", true, "", "");
...
function Bundle$Terminal(Data, Scr) {
    ...
    if (data[Data]) {
        ...
        if (Scr == "Terminal") {
            ...
            BEMA("TextArea", "OpenBundle.Terminal." + instanceIDd + ".WindowHeader", 100+100, 50+100, windowWidth, 25, false, 0, 0, "", TermSurface0, TermText, "Terminal", "center", 12, "Tahoma", true, "", "");
...
function Bundle$TextEdit(Data, Scr, docID) {
    ...
    if (data[Data]) {
        ...
        if (Scr == "TextEdit") {
            ...
            BEMA("TextArea", "OpenBundle.TextEdit." + instanceIDd + ".WindowHeader", 100+100, 35+100, 300, 25, false, 0, 0, "", Surface0, Text, "Text Edit", "center", 12, "Tahoma", true, "", "");
...
function Bundle$Tips(Data, Scr) {
    ...
    if (data[Data]) {
        ...
        if (Scr == "Tips") {
            ...
            BEMA("TextArea", "OpenBundle.Tips." + instanceIDd + ".WindowHeader", 100+100, 35+100, 300, 25, false, 0, 0, "", Surface0, Text, "Tips", "center", 12, "Tahoma", true, "", "");
