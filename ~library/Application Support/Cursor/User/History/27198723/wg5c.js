...
function Bundle$Calculator(Data, Scr) {
    ...
    if (data[Data]) {
        ...
        if (Scr == "Calculator") {
            ...
            eBEMA.Element("TextArea", "OpenBundle.Calculator." + instanceIDd + ".Window", 100, 35, windowWidth, 260, false, 10, 0, "", Base, Text, "", "left", 16, "Tahoma", true, "", "");
            eBEMA.Element("TextArea", "OpenBundle.Calculator." + instanceIDd + ".WindowHeader", 100, 35, windowWidth, 25, false, 10, 0, "", Surface0, Text, "Calculator", "center", 12, "Tahoma", true, "", "");
            eBEMA.Element("TextArea", "OpenBundle.Calculator." + instanceIDd + ".Display", 100, 60, windowWidth, 50, false, 10, 0, "", Base, Text, "0", "right", 20, "Tahoma", true, "", "");
            eBEMA.Element("Button", "OpenBundle.Calculator." + instanceIDd + ".Bar.1", 100, 35, 25, 25, false, 10, 0, "rgb(0,0,0,0)", Surface1, Text, "", "left", 0, "Tahoma", true, "icon://fa-times", Text);
            ...
            buttons.forEach(function(button) {
                eBEMA.Element("Button", "OpenBundle.Calculator." + instanceIDd + ".Button." + button.label, button.x, button.y, 45, 45, false, 10, 0, "", Surface1, Text, button.label, "center", 16, "Tahoma", true, "", "");
