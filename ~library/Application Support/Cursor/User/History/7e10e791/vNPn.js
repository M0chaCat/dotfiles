...
class showHiddenChannels {
  ...
  preferencesArray = Object.entries(this.info.preferences);

  // Ensure preferencesArray is used correctly
  usePreferences() {
    for (const [key, value] of this.preferencesArray) {
      // Example usage of preferencesArray
      console.log(`Preference: ${key}, Value: ${JSON.stringify(value)}`);
    }
  }
}
