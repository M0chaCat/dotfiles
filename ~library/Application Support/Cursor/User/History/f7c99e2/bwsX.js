...
function Bundle$Settings(Data, Scr) {
    ...
    if (data[Data]) {
        ...
        if (Scr === "About") {
            ...
            setText("OpenBundle.SettingsAbout." + instanceIDd + ".Text.1", "Next version "+Version+"\nMWK version "+MWK.MWKVersion()+"");
        ...
        if (Scr === "Wallpapers") {
            ...
            onEvent("OpenBundle.Wallpaper." + instanceIDd + ".Button.2", "click", function() {
                Next.setWallpaper(getProperty("OpenBundle.Wallpaper." + instanceIDd + ".Button.2", "image"));
            });
            onEvent("OpenBundle.Wallpaper." + instanceIDd + ".Button.3", "click", function() {
                Next.setWallpaper(getProperty("OpenBundle.Wallpaper." + instanceIDd + ".Button.3", "image"));
            });
            onEvent("OpenBundle.Wallpaper." + instanceIDd + ".Button.4", "click", function() {
                Next.setWallpaper(getProperty("OpenBundle.Wallpaper." + instanceIDd + ".Button.4", "image"));
            });
