...
BEMA('Image', 'largeImage', 50, 20, 700, 200, false, 0, 0, Blank, null, null, null, null, null, false, 'testimage.png', 'testimage.png');
...
AppInfo.filter(app => app.featured).forEach(app => {
    ...
    BEMA('TextArea', `${app.id}-name`, xOffset, 350, 100, 20, false, 0, 0, null, Surface0, Text, app.name, app.name, app.name, null, false, null);
