...
BEMA('Image', 'largeImage', 0, 0, 820, 200, false, 0, 0, Blank, null, null, null, null, null, false, './testimage.png', 'testimage.png');
BEMA('TextArea', 'FeaturedApps', 50, 220, 100, 20, false, 0, 0, null, Surface0, Text, 'Featured Apps', 'center', null, null, false, null, null);
        
// Function to create a row of featured apps
function createFeaturedRow() {
    let xOffset = 50;
    AppInfo.filter(app => app.featured).forEach(app => {
        BEMA('Image', `${app.id}-featured`, xOffset, 210, 100, 100, false, 0, 0, Blank, null, null, null, null, null, false, app.icon, null);
        BEMA('TextArea', `${app.id}-name`, xOffset, 320, 100, 20, false, 0, 0, null, Surface0, Text, app.name, 'center', null, null, false, null, null);
...
function createAppGrid() {
    ...
    AppInfo.forEach((app, index) => {
        BEMA('Image', `${app.id}-icon`, x, y, 100, 100, false, 0, 0, Blank, null, null, null, null, null, false, app.icon, null);
        BEMA('TextArea', `${app.id}-name`, x, y + 110, 100, 20, false, 0, 0, null, Surface0, Text, app.name, 'center', null, null, false, null, null);
