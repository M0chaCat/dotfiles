...
function createFeaturedRow() {
    ...
    AppInfo.filter(app => app.featured).forEach(app => {
        BEMA('Image', `${app.id}-featured`, xOffset, 210, 100, 100, false, 0, 0, Blank, null, null, null, null, null, false, null, app.icon);
...
function createAppGrid() {
    ...
    AppInfo.forEach((app, index) => {
        BEMA('Image', `${app.id}-icon`, x, y, 100, 100, false, 0, 0, Blank, null, null, null, null, null, false, null, app.icon);
