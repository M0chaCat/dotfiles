...
BEMA('TextArea', 'FeaturedAppsText', 50, 220, 200, 40, false, 0, 0, "", Surface0, Text, 'Featured Apps', 'center', "20", "Arial", false, "", "");
BEMA('TextArea', 'AppsText', 50, 500, 200, 40, false, 0, 0, "", Surface0, Text, 'Featured Apps', 'center', "20", "Arial", false, "", "");
...
function createFeaturedRow() {
    ...
    AppInfo.filter(app => app.featured).forEach(app => {
        ...
        BEMA('TextArea', `${app.id}-name`, xOffset, 420, 100, 20, false, 0, 0, "", Surface0, Text, app.name, 'center', "", "", false, "", "");
