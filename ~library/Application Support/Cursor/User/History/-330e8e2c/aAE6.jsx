...
function EssentialzTab({ WebpackModules }) {
  // Ensure React and other components are available in the scope
  const { React, FormSection, Card, Text } = WebpackModules;
...
class Essentialz {
  ...
  renderEssentialzTab() {
    ...
    return <EssentialzTab WebpackModules={this.WebpackModules} />;
  }
