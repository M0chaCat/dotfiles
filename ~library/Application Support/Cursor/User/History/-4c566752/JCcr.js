...
var Version = "0.8";
var CompatableFirmware = 3;
var tipsAppText = "Welcome to the Celeste Public Test Wave 2";
...
function boot() {
  ...
  Celeste.InstallApp("Terminal", "icon://fa-terminal");
  Celeste.InstallApp("NetStar", "icon://fa-cloud");
  //Celeste.InstallApp("Solstis", "icon://fa-phone");
...
timedLoop(900, function() { //clock
  setText("Celeste.Main.Dock.Time", MWK.getTime("hh:mm:ss a"));
});
