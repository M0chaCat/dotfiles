...
contextBridge.exposeInMainWorld('api', {
    ...
    commands: {
        ...
        openBundles: {
            RegisterAppBundle: openBundles.openBundles$RegisterAppBundle,
            hideIcons: openBundles.openBundles$hideIcons,
            showIcons: openBundles.openBundles$showIcons,
            addApp: openBundles.openBundles$addApp,
            getApps: openBundles.openBundles$getApps,
        }
    }
});