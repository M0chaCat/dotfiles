...
const celesteFirmware = require('./celestefirmware.js');
...
contextBridge.exposeInMainWorld('api', {
    ...
    Celeste: {
        Celeste$FirmwareVersion: celesteFirmware.Celeste$FirmwareVersion,
        Celeste$Boot: celesteFirmware.Celeste$Boot,
        Celeste$UninstallApp: celesteFirmware.Celeste$UninstallApp,
        Celeste$setWallpaper: celesteFirmware.Celeste$setWallpaper,
        Celeste$InstallApp: celesteFirmware.Celeste$InstallApp,
    }
});