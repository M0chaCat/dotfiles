...
class KeyboardSounds {
  ...
  onEnable() {
    ...
    if (isClickySounds) {
      ...
      // Load soft sounds
      sounds.click1 = new Audio("https://github.com/opera-gaming/gxmods/raw/main/mods/Soft/sounds/soft1.wav"); // Replace with actual URL
      sounds.click2 = new Audio("https://github.com/opera-gaming/gxmods/raw/main/mods/Soft/sounds/soft2.wav"); // Replace with actual URL
      sounds.click3 = new Audio("https://github.com/opera-gaming/gxmods/raw/main/mods/Soft/sounds/soft3.wav"); // Replace with actual URL
      sounds.backspace = new Audio("https://github.com/opera-gaming/gxmods/raw/main/mods/Soft/sounds/softbackspace.wav"); // Replace with actual URL
      ...
      sounds.click2 = new Audio("https://github.com/opera-gaming/gxmods/raw/main/mods/Fart/sounds/keyboard2.mp3"); // Replace with actual URL
      ...
      sounds.backspace = new Audio("https://github.com/opera-gaming/gxmods/raw/main/mods/Fart/sounds/keyboard4.mp3"); // Replace with actual URL
    }
