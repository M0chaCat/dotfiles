...
function Bundle$Calculator(Data, Scr) {
    ...
    if (data[Data]) {
        ...
        if (Scr == "Calculator") {
            ...
            var buttons = [
                { label: "7", x: 100, y: 70 }, { label: "8", x: 150, y: 70 }, { label: "9", x: 200, y: 70 }, { label: "/", x: 250, y: 70 },
                { label: "4", x: 100, y: 120 }, { label: "5", x: 150, y: 120 }, { label: "6", x: 200, y: 120 }, { label: "*", x: 250, y: 120 },
                { label: "1", x: 100, y: 170 }, { label: "2", x: 150, y: 170 }, { label: "3", x: 200, y: 170 }, { label: "-", x: 250, y: 170 },
                { label: "0", x: 100, y: 220 }, { label: ".", x: 150, y: 220 }, { label: "=", x: 200, y: 220 }, { label: "+", x: 250, y: 220 }
            ];
