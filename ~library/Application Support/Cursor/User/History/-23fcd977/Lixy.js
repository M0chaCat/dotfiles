...
function Bundle$Calculator(Data, Scr) {
    ...
    if (data[Data]) {
        ...
        if (Scr == "Calculator") {
            ...
            var buttons = [
                { label: "7", x: 100, y: 120 }, { label: "8", x: 150, y: 120 }, { label: "9", x: 200, y: 120 }, { label: "/", x: 250, y: 120 },
                { label: "4", x: 100, y: 170 }, { label: "5", x: 150, y: 170 }, { label: "6", x: 200, y: 170 }, { label: "*", x: 250, y: 170 },
                { label: "1", x: 100, y: 220 }, { label: "2", x: 150, y: 220 }, { label: "3", x: 200, y: 220 }, { label: "-", x: 250, y: 220 },
                { label: "0", x: 100, y: 270 }, { label: ".", x: 150, y: 270 }, { label: "=", x: 200, y: 270 }, { label: "+", x: 250, y: 270 }
            ];
            ...
            onEvent("OpenBundle.Calculator." + instanceIDd + ".WindowHeader", "mousedown", function(event) {
                startDrag(event, "OpenBundle.Calculator." + instanceIDd + ".Window", [
                    ...
                    "OpenBundle.Calculator." + instanceIDd + ".Display",
                    "OpenBundle.Calculator." + instanceIDd + ".Buttons",
                    ...buttons.map(button => "OpenBundle.Calculator." + instanceIDd + ".Button." + button.label) // Include buttons in the drag
                ]);
            });
        }
    ...
    function setText(elementId, text) {
        ...
        return setText(elementId, text); // Updated to use setText
    }
}
