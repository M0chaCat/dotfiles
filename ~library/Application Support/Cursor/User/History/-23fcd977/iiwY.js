...
function Bundle$Calculator(Data, Scr) {
    ...
    if (data[Data]) {
        ...
        if (Scr == "Calculator") {
            ...
            BEMA.Element("TextArea", "OpenBundle.Calculator." + instanceIDd + ".Window", 100, 35, windowWidth, 260, false, 10, 0, "", Base, Text, "", "left", 16, "Tahoma", true, "", "");
            BEMA.Element("TextArea", "OpenBundle.Calculator." + instanceIDd + ".WindowHeader", 100, 35, windowWidth, 25, false, 10, 0, "", Surface0, Text, "Calculator", "center", 12, "Tahoma", true, "", "");
            BEMA.Element("TextArea", "OpenBundle.Calculator." + instanceIDd + ".Display", 100, 60, windowWidth, 50, false, 10, 0, "", Base, Text, "0", "right", 20, "Tahoma", true, "", "");
