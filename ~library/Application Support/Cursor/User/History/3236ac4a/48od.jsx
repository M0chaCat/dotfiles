...
var MenuGroup = Nekocord.webpackModules.commonModules.MenuGroup;
var MenuItem = Nekocord.webpackModules.commonModules.MenuItem;
      ...
      ["guild-header-popout"]: [
          {
              ...
              render: () => {
                  return (
                      <MenuGroup>
                          <MenuItem id="test" label="test" action={() => {}} />
                      </MenuGroup>
                  );
              }
          }
