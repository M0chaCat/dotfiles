...
function Bundle$Settings(Data, Scr) {
    ...
    if (data[Data]) {
        ...
        if (Scr === "Settings") {
            ...
            BEMA("Button", "OpenBundle.Settings." + instanceIDd + ".Bar.2", barX + 25, barY, 80, 25, false, 10, 0, "", Surface0, Text, "Back", "center", 11, "Tahoma", true, "left-arrow.png", "");
            ...
            onEvent("OpenBundle.Settings." + instanceIDd + ".Bar.2", "click", function() {
                Bundle$Settings("HideAll", "OpenBundle$Settings");
        ...
        if (Scr === "About") {
            ...
            BEMA("Button", "OpenBundle.SettingsAbout." + instanceIDd + ".Bar.2", barX + 25, barY, 80, 25, false, 10, 0, "", Surface0, Text, "Back", "center", 11, "Tahoma", true, "left-arrow.png", "");
