...
function Bundle$Settings(Data, Scr) {
    ...
    if (data[Data]) {
        ...
        if (Scr === "About") {
            ...
            BEMA("Button", "OpenBundle.SettingsAbout." + instanceIDd + ".Bar.2", barX + 25, barY, 80, 25, false, 10, 0, "rgb(0,0,0,0)", Surface1, Text, "", "center", 11, "Tahoma", true, "left-arrow.png", "");
        ...
        if (Scr === "Wallpapers") {
            ...
            BEMA("Button", "OpenBundle.Wallpaper." + instanceIDd + ".Bar.2", barX + 25, barY, 80, 25, false, 10, 0, "rgb(0,0,0,0)", Surface1, Text, "", "center", 11, "Tahoma", true, "left-arrow.png", "");
            for (var i = 0; i < numColumns * numRows; i++) {
                var col = i % numColumns;
                var row = Math.floor(i / numColumns);
