...
// Check if openBundles exists before destructuring
   ...
   //Celeste.Main
    ...
    BEMA("TextArea", "Celeste.Main.Dock.Time", 475, 517.5, 300, 45, true, 15, 0, Mantle, Mantle, Text, "MEOW :3", "right", 25, "Tahoma", true, "", Text);
    ...
    if (data[Data]) {
        ...
        if (Scr == "Jukebox") {
            ...
            onEvent("OpenBundle.Jukebox." + instanceIDd + ".Bar.2", "click", function() {
                stopSound();
                setText("OpenBundle.Jukebox." + instanceIDd + ".Text.1", "No song playing");
            });
...
function Bundle$Settings(Data, Scr) {
    ...
    if (data[Data]) {
        ...
        if (Scr === "Settings") {
            ...
            BEMA("Button", "OpenBundle.Settings." + instanceIDd + ".Button.1", buttonX, buttonY, 80, 25, false, 10, 0, "", Surface0, Text, " Wallpapers", "left", 11, "Tahoma", true, "", "");
            BEMA("Button", "OpenBundle.Settings." + instanceIDd + ".Button.2", buttonX + 85, buttonY, 80, 25, false, 10, 0, "", Surface0, Text, " About", "left", 11, "Tahoma", true, "", "");
        ...
        if (Scr === "About") {
            ...
            BEMA("TextArea", "OpenBundle.SettingsAbout." + instanceIDd + ".Text.1", textX, textY, 300, 175, false, 10, 0, "rgb(0,0,0,0)", Base, Text, "", "left", 10, "Tahoma", true, "times.png", Text);
        ...
        if (Scr === "Wallpapers") {
            ...
            setProperty("OpenBundle.Wallpaper." + instanceIDd + ".Button.2", "image", "Celeste 10-7-6k.png");
            setProperty("OpenBundle.Wallpaper." + instanceIDd + ".Button.3", "image", "10-8-6k.jpg");
            setProperty("OpenBundle.Wallpaper." + instanceIDd + ".Button.4", "image", "10-12-6k.jpg");
            hideElement("OpenBundle.Wallpaper." + instanceIDd + ".Button.5");
            hideElement("OpenBundle.Wallpaper." + instanceIDd + ".Button.6");
...
function Bundle$StickyNote(Data, Scr) {
    ...
    if (data[Data]) {
        ...
        if (Scr == "StickyNote") {
            ...
            BEMA("Button", "OpenBundle.StickyNote." + instanceIDd + ".WindowHeader", 100, 100, 200, 15, false, 0, 0, "", "#e8d19e", Base, "", "center", 5, "Tahoma", true, "", "");
            BEMA("TextArea", "OpenBundle.StickyNote." + instanceIDd + ".Text.1", 100, 120, 200, 185, false, 0, 0, "", "#f9e2af", Base, currentNote, "left", 11, "Tahoma", false, "", "");

            onEvent("OpenBundle.StickyNote." + instanceIDd + ".WindowHeader", "click", function() {
