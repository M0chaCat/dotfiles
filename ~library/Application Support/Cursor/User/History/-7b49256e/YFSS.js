window.icons = ["", "", "", "", "", "", "", "", "", "", "", ""];
window.BarIcons = ["", "", "", "", ""];
const { setText, setProperty, showElement, hideElement, setImageURL, setWallpaper, getUserId, readRecords, createRecord, updateRecord, generateRandomString, getTime, getDate, stopTimedLoop, Alert, CheckValid, Internal } = require("./Commands.js");
