    ...
    BEMA.Element("TextArea", "Celeste.Main.Dock.Time", 320, 350, 200, 25, false, 10, 0, "", Blank, Text, "", "right", 15, "Lucida", true, "", Text);
    setStyle("Celeste.Main.Dock", "z-index: 10");
    setStyle("Celeste.Main.Dock.Time", "z-index: 10");

    BEMA.Element("Button", "Celeste.Main.Dock.0", 15, 340, 50, 50, false, 10, 3, Base, Base, Text, "", "left", 5, "Tahoma", true, "normal.PNG", Text);
    ...
    setStyle("Celeste.Main.Dock.0", "z-index: 11");
    setStyle("Celeste.Main.Dock.1", "z-index: 11");
    setStyle("Celeste.Main.Dock.2", "z-index: 11");
    setStyle("Celeste.Main.Dock.3", "z-index: 11");
    setStyle("Celeste.Main.Dock.4", "z-inc
    setStyle("Celeste.Main.Dock.5", "z-index: 11");
