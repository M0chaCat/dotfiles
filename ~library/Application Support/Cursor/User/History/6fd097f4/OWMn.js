...
class Essentials {
  ...
  constructor(userPreferences) {
    ...
    console.log("User Preferences:", this.userPreferences); // Log userPreferences
    console.log("User Preferences:", this.userPreferences.ArcaneTweaks); // Log userPreferences
  }
  onPreferencesChange() {
